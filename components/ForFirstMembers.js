    ...
    <section className="bg-slate-900 py-20 lg:py-28 relative overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <div className="inline-flex items-center gap-2 bg-amber-400/20 text-amber-300 text-sm font-semibold px-3 py-1.5 rounded-full mb-6">
            ...
            <ul className="space-y-3 mb-10">
              {perks.map((perk) => (
                <li key={perk} className="flex items-start gap-3">
                  <span className="flex-shrink-0 w-5 h-5 rounded-full bg-amber-400/20 text-amber-400 flex items-center justify-center mt-0.5">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 bg-amber-400 hover:bg-amber-500 text-amber-900 font-bold px-7 py-4 rounded-xl text-base transition-colors"
            >
              Подати заявку →
            </a>
          </div>
          ...
          <div className="hidden lg:flex items-center justify-center">
            <div className="relative">
              <div className="w-56 h-56 rounded-full bg-blue-600/10 absolute -inset-8" />
              <div className="relative w-40 h-40 rounded-full border-2 border-dashed border-slate-600 flex items-center justify-center">
                <div className="text-center">
                  <div className="text-5xl font-black text-white">25</div>
                  <div className="text-slate-400 text-sm mt-1">місць</div>
                </div>
              </div>
              {[...Array(8)].map((_, i) => (
                <div
                  key={i}
                  className="absolute w-8 h-8 rounded-full bg-slate-700 border-2 border-slate-600 flex items-center justify-center"
                  style={{
